...
WITH products (
    ...
    VALUES
        ...
        ('Lowes', 'review_body_count',
         '리뷰 수·본문 확인 필요',
         'count_of_reviews', 'detailed_review_content',
         'Lowes 사이트 특성 후보이며 이상치가 아닌 확인 필요 항목입니다.',
         'count_of_reviews|count_of_star_ratings|detailed_review_content', 60),
