...
VALUES
    ...
    ('review_body_decrease', '최근 5일 내 직전 수집 대비 리뷰본문 감소',
     ...
     '수집 완료 후 당일을 제외한 이전 5일 중 같은 상품의 가장 최근 수집 기록과 비교합니다. 리뷰 수와 별점 수가 같고 둘 다 감소하면 본문 감소는 정상입니다. 카운트가 함께 감소하지 않거나 서로 다른 상태에서 본문이 감소하면 이상입니다. 별점 점수 하락만으로 정상 처리하지 않습니다.',
