...
WITH seed (name, description, check_type, pattern) AS (
    VALUES
        ...
        ('SEA_APPLIANCE_BESTBUY_PICKUP',
         'Bestbuy pickup date, Pick up today or Pick up tomorrow', 'regex',
         $pickup$^Pick up (today|tomorrow|(Mon|Tue|Wed|Thu|Fri|Sat|Sun), (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) ([1-9]|[12][0-9]|3[01]))$$pickup$),
    ...
    CROSS JOIN LATERAL (
        VALUES
            ...
            ('pick_up_availability', 'SEA_APPLIANCE_BESTBUY_PICKUP',
             'pick_up_availability는 Pick up 요일, 월 일, Pick up today 또는 Pick up tomorrow 형식이어야 합니다.'),
