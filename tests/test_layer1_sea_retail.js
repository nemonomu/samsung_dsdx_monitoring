...
(async function run() {
    ...
    assert.ok(retailTemplate.includes("{% static 'dx_layer1/js/retail.js' %}?v=20260921-batches1"));
    assert.ok(dashboardTemplate.includes("{% static 'dx_layer1/js/retail.js' %}?v=20260921-batches1"));
