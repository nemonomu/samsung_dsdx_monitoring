...
assert(baseTemplate.includes('dx_layer3/css/layer3.css\' %}?v=7'));
...
assert(source.includes("'review_body_count', 'max_review_number', 'review_body_criterion'"));
assert(source.includes("review_body_count: { label: '리뷰본문 수'"));
assert(source.includes("max_review_number: { label: '최대 reviewN'"));
