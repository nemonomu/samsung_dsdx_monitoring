...
class TseRetailCommonTests(unittest.TestCase):
    ...
    def test_collection_phase_uses_kst_1030_completion_boundary(self):
        ...
        self.assertEqual(get_tse_collection_phase(time(10, 29, 59)), 'collecting')
        self.assertEqual(get_tse_collection_phase(time(10, 30)), 'collecting')
        self.assertEqual(get_tse_collection_phase(time(10, 30, 1)), 'complete')
