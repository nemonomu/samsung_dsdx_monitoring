...
async function openRuleModal(tableName, retailer) {
    ...
    const tableNameMap = {
        ...
        'SEDA TV': 'seda_tv', 'seda_tv_retail': 'seda_tv',
        'SEDA REF': 'seda_ref', 'seda_ref_retail': 'seda_ref',
        'SEDA LDY': 'seda_ldy', 'seda_ldy_retail': 'seda_ldy',
        ...
        'SEM TV': 'sem_tv',
        'sem_tv_retail': 'sem_tv',
        'SEM REF': 'sem_ref',
        'sem_ref_retail': 'sem_ref',
        'SEM LDY': 'sem_ldy',
        'sem_ldy_retail': 'sem_ldy',
        'TSE TV': 'tse_tv',
